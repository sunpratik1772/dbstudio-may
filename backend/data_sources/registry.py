...
The `semantic` field is the seam for a future semantic layer
(see the audit's "Ultimate Test"). For the pre-review ship we just
land the metadata; the resolver is a follow-up.
"""
